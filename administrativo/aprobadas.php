...
<head>
  ...
  <title>Lista de Solicitudes Aprobadas</title>
</head>
<body>
...
<body>
  <div class="container">
    <div class="row mt-5" id="header">
      <div class="col">
        <h3>WorkFlow / Lista de Solicitudes Aprobadas</h3>
        <a href="../empleado/solicitud.php" class="btn btn-primary">Añadir Nueva Solicitud</a>
        <a href="http://suenosdecolorespijamas.com/graficas/index.php" class="btn btn-primary">Ver Estadisticas</a>
