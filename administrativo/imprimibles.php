...
<head>
  ...
  <title>Formatos Imprimibles</title>
</head>
<body>
...
<body>
  <div class="container">
    <div class="row mt-5" id="header">
      <div class="col">
        <h3>WorkFlow / Imprima el Documento Requerido</h3>
        <a href="../empleado/solicitud.html" class="btn btn-primary">Añadir Nueva Solicitud</a>
    ...
    <div class="col">
        <div class="table-responsive">
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th class="titlesTable">Fecha Solicitud</th>
                        <th>Cedula</th>
                        <th>Trabajador</th>
                        <th>Duracion</th>
                        <th>Motivo</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="pdf-content.php?cedula=<?php echo $row['cedula']; ?>" class="btn btn-success"> Imprimir</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
